...
class ShareSplitExplainPopup: UIView {
    ...
    init(into container: UIView) {
        ...
        self.backgroundColor = UIColor(hex: 0x1B2239)
        ...
        NSLayoutConstraint.activate([
            ...
            button2.leadingAnchor.constraint(equalTo: self.leadingAnchor, constant: 20),
        ...
        NSLayoutConstraint.activate([
            ...
            button3.leadingAnchor.constraint(equalTo: self.leadingAnchor, constant: 20),
        ...
        NSLayoutConstraint.activate([
            ...
            label1.trailingAnchor.constraint(equalTo: self.trailingAnchor, constant: -31),
        ...
        NSLayoutConstraint.activate([
            ...
            label2.trailingAnchor.constraint(equalTo: self.trailingAnchor, constant: -31),
        ...
        NSLayoutConstraint.activate([
            ...
            label3.trailingAnchor.constraint(equalTo: self.trailingAnchor, constant: -31),
        ...
        NSLayoutConstraint.activate([
            ...
            dontShowButton.leadingAnchor.constraint(equalTo: self.leadingAnchor, constant: 20),
            dontShowButton.trailingAnchor.constraint(equalTo: self.trailingAnchor, constant: -20),
